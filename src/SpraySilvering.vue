<template>
  <div>
    ...
    <h2 class="font-bold text-xl">The chemicals</h2>
    <div class="card bg-base-200 p-3 mb-3">
      ...
      <p class="text-xs">
        ...
        <span class="badge badge-error badge-xs">Bottle 2</span> with water,
        ensuring that the same quantity of water is sprayed with 100 sprays.
      </p>
    </div>
    <div class="card bg-base-200 p-3 mb-3">
      <div class="flex items-center gap-2 mb-2">
      ...
      <div class="field-horizontal">
        <label class="label text-xs font-medium">Base quantity (ml):</label>
        <input
          type="number"
    ...
    <div class="card bg-base-200 p-3 mb-3">
      <div class="flex items-center gap-2 mb-2">
        ...
        <h2 class="text-sm font-bold">Mixing of silver solution</h2>
      </div>
      <p>
        (becomes <span class="badge badge-neutral badge-xs">Bottle 1</span>)
      </p>
      <ul class="list-disc list-inside space-y-2 text-xs">
        ...
        <li>
          5 : Carefully add
          <strong>ammonia solution drop by drop</strong> while stirring until a
          transparent, slightly brownish solution is obtained.
        </li>
      </ul>
    </div>
    <p>
    ...
    <hr class="my-4" />
    <h2 class="font-bold text-xl mb-4">The cleaning and spraying</h2>
    <h2 class="title font-bold">Clean the mirror</h2>
    <p class="mb-2">
      Use chalk precipitate in distilled/demin water on small cotton balls.
      Change often and start with thick sauce, thinning it progressively. The
      center will clean fast but the edge and chamfer need a LOT of time.<br /><br />Rough
      guideline : <code>(diameter_in_mm/15)^1.4 = time</code>.<br />Yes, that is
      an advice of 1h40 for a 400mm mirror.<br /><br />Rinse with demin water
      and if possible, high pressure.
    </p>
    <OpticalPieceSelector @optical-piece-selected="onOpticalPieceSelected" />
    <div class="rounded-md bg-gray-200 p-2">
      <label for="" class="label is-small"> Mirror diameter in mm: </label>
      <input
    ...
    <hr />
    <h2 class="title font-bold my-2">Spray the mirror</h2>
    <p>
      Spray the mirror with both sprays, ensuring that they mix on the surface.
      You will see a faint blue film appear first.<br />Then it will turn
      yellowish. If you see dark brown or black streaks, this means your
      cleaning wasn't thorough enough.<br />A thin coating is preferable to a
      thick one and it should still be a tad transparent at the end.
    </p>
    <h2 class="title font-bold my-2">Dry & store</h2>
    <p>
      Immediately dry with a hot air gun and store in an airtight box with
      dessicant packs, or better, silver protector felt. Silver protector felt
      is felt impregnated with tiny silver particles that are there to react
      with oxydants first and protect your coating.
    </p>
  </div>
</template>
    ...
    loadBomItems() {
      ...
      if (savedItems) {
        ...
        defaultItems.forEach((item) => {
          if (!parsedItems.find((saved) => saved.name === item.name)) {
